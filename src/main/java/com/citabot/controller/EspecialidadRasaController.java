...
public class EspecialidadRasaController {
    ...
    @GetMapping(path = "/disponibles/dia/{dia}")
    public List<Especialidad> getDisponiblesDia(@PathVariable("dia") String dia){
        return service.listarDisponiblesPorDias(dia);
    }
